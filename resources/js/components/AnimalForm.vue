    ...
    <form method="POST" :action="getRouteFormSubmit()" enctype="multipart/form-data">
        ...
        <div class="form-row row mb-3">
            <div class="form-group col-md-4">
                <label class="form-label" for="animal-number">Animal number</label>
                <input type="text" class="form-control border border-dark-subtle" id="animal-number" name="animal-number" placeholder="Number"
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control border border-dark-subtle" id="gender" name="gender">
                    <option>---</option>
        ...
        <div class="form-row row mb-3">
            <div class="form-group col-md-4">
                ...
                <input type="text" id="name" name="name" class="form-control border border-dark-subtle" placeholder="Name"
                    v-model="oldvalues['name']">
            </div>
            <div class="form-group col-md-4">
                <label class="form-label" for="size">Size</label>
                <select class="form-control border border-dark-subtle" id="size" name="size">
                    <option>---</option>
        ...
        <div class="form-row row mb-3">
            <div class="form-group col-md-4">
                ...
                <select class="form-control border border-dark-subtle" id="breed" name="breed[]" multiple>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control border border-dark-subtle" id="birthdate" name="birthdate" :value="oldvalues['birthdate']">
                <span class="word-separator">or</span>
                <input type="number" class="form-control border border-dark-subtle" id="age-digit" name="age-digit" min="1"
                    v-model="oldvalues['age-digit']">
                <select class="form-control border border-dark-subtle" id="age-unit" name="age-unit">
            ...
            <div class="form-group col-md-4">
                <label class="form-label" for="microchip">Microchip number</label>
                <input type="text" class="form-control border border-dark-subtle" id="microchip" name="microchip" placeholder="Microchip number"
        ...
        <div class="form-row row mb-3">
            ...
            <div class="form-group col-md-4">
                <label class="form-label" for="intake-date">Intake Date</label>
                <input type="datetime-local" class="form-control border border-dark-subtle" id="intake-date" name="intake-date"
                    :value="(editform ? oldvalues['intake_date'].replace(' ', 'T') : oldvalues['intake-date']) || date">
            </div>
            <div class="form-group col-md-4">
                <label class="form-label" for="living-area">Living area</label>
        ...
        <div class="form-row row mb-3">
            <div class="form-group col-md-4">
                <label class="form-label" for="bring-in-person">Person bringing animal in</label>
            ...
            <div class="form-group col-md-4">
                <label class="form-label" for="call">Reference call</label>
                <searchable-select :options="calls" name="call" placeholder="Reference call"
                    :default="oldvalues[editform ? 'call_id' : 'call']" />
            </div>
            <div class="form-group col-md-4">
                <label class="form-label" for="intake-type">Intake type</label>
                <select class="form-control border border-dark-subtle" id="intake-type" name="intake-type">
                    <option>---</option>
        ...
        <div class="form-row row mb-3">
            <div class="form-group col-md-3">
                ...
                <input type="checkbox" name="is-neutered" id="is-neutered" class="form-check-input"
                    :checked="oldvalues[editform ? 'is_neutered' : 'is-neutered'] == '1' ? 'checked' : ''">
                <label class="form-label" for="is-neutered">Spayed/neutered</label>
            </div>
        </div>
        <div class="form-row row mb-3">
            <div class="form-group col-md-8">
                <label class="form-label" for="notes">Notes</label>
                <textarea class="form-control border border-dark-subtle" name="notes" id="notes" rows="4" v-model="oldvalues['notes']"></textarea>
            </div>
        </div>
        <div class="form-row row mb-3" v-if="editform">
